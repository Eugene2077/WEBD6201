...
/*
Promises are used in JavaScript to handle asynchronous operations such as network requests, file I/O, and database queries. Prior to the introduction of Promises in ES6, callbacks were commonly used to handle asynchronous code. However, callbacks can lead to callback hell, which is a situation where the code becomes difficult to read and maintain due to nested callbacks.
