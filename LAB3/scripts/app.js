...
//-------------- commented out these JScript operations after change the top nav bar as below ------------------------------
...
// Nav Bar on Top of the pages
$(function () {
    let navBar = 
        `<ul class="nav">
            <li class="nav-item">
                <a class="nav-link font-nav-top active" href="./index.html">Home</a>
            </li>
            <li class="nav-item">
                <a class="nav-link font-nav-top" href="./products.html">Interest</a>
            </li>
            <li class="nav-item">
                <a class="nav-link font-nav-top" href="./services.html">Service</a>
            </li>
            <li class="nav-item">
                <a class="nav-link font-nav-top" href="./about.html">About</a>
            </li>
            <li class="nav-item">
            <a class="nav-link font-nav-top" href="./blog.html">Blog</a>
            </li>
            <li class="nav-item">
                <a class="nav-link font-nav-top" href="./contact.html">Contact</a>
            </li>
            <li class="nav-item">
                <a class="nav-link font-nav-top" href="./login.html">Login/out</a>
            </li>
        </ul>   `;
